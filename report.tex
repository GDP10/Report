...
The project customer was Snowflake Software, a company that works in geographical data exchange services. The focus of this project is the exchange of aeronautical data between flight planners and data publishers such as the Federal Notam Service and the Aeronautical Information Service. Snowflake were planning to implement a data exchange service for clients that would allow consumers to recieve aeronautical data in the form of NOTAMS, using a push notification service. Our group was given the task: "To demonstrate the feasibility of using Publish/Subscribe to communicate relevant NOTAMs to flight planners". In other terms, our work was to research what architectures existed to do push notification and which would work with the requested standard of WS-Notification.
...
\item Capable of spatial filtering of NOTAMs based on distances from points.
\item Capable of spatial filtering of NOTAMs based on locations within bounding boxes.
...
\begin{enumerate}
\item Temporal filtering of NOTAMs.
