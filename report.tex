...
The deliverables for our project were dictated both by the requirements of our customer and the module requirements. Snowflake required the production of a proof of concept service which fulfilled their requirements, whereas the module required several more deliverables.
...
Cucumber tests easily made the transition on Travis and improved consistency with the existing Git workflow.
...
\begin{tabularx}{\textwidth}{|X|X|} \hline
  ...
  \fullref{sec:intro_customer}           & Peter Prince                       \\
  ...
  \fullref{sec:plan_risk_analysis}       & -                                  \\
  \fullref{sec:plan_customer_relations}  & Peter Prince                       \\
  \fullref{sec:plan_deliverables}        & -                                  \\
